...
<body class="login-body">
      ...
      <div class="col-12 col-sm-10 col-md-8 col-lg-5">
        <div class="card login-card shadow-lg border-0">
          <div class="card-body p-4 p-md-5">
            <?php include __DIR__ . '/public/partials/auth_lang_dropdown.php'; ?>
            <h1 class="h3 mb-4 text-center fw-semibold"><?php echo htmlspecialchars(t('login.heading'), ENT_QUOTES, 'UTF-8'); ?></h1>
            <form id="loginForm" method="post" action="public/login.php" novalidate>
              ...
              <div class="text-center mt-3">
                <a href="public/forgot_password.php" class="forgot-link"><?php echo htmlspecialchars(t('login.forgot_password'), ENT_QUOTES, 'UTF-8'); ?></a>
              </div>
            </form>
          </div>
        </div>
  ...
  <script src="public/assets/js/auth_lang_dropdown.js"></script>
  <script>
  ...
  <script src="public/assets/js/login_validation.js"></script>
</body>
</html>
