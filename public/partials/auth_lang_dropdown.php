...
$flagMap = ['pt' => 'br', 'en' => 'gb', 'es' => 'es', 'it' => 'it'];
$locKey = array_key_exists($loc, $langOpts) ? $loc : 'pt';
$currentFlag = $flagMap[$locKey] ?? 'br';
...
<div class="d-flex justify-content-end mb-3">
  <div class="auth-lang-dropdown" id="authLangRoot">
    ...
    >
      <span class="auth-lang-flag fi fi-<?php echo htmlspecialchars($currentFlag, ENT_QUOTES, 'UTF-8'); ?>" aria-hidden="true"></span>
...
<?php $flagCode = $flagMap[$code] ?? 'br'; ?>
      ...
      >
        <span class="auth-lang-flag fi fi-<?php echo htmlspecialchars($flagCode, ENT_QUOTES, 'UTF-8'); ?>" aria-hidden="true"></span>
      </li>
<?php endforeach; ?>
    </ul>
  </div>
